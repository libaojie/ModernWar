...
namespace BehaviorDesigner.Runtime.Tasks.Movement.AstarPathfindingProject.AIPath
{
    ...
    public class Search : Action
    {
        ...
        public SharedTransform searchObject;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (searchObject.Value != null) {
                objectFound.Value = MovementUtility.WithinSight(transform, offset.Value, fieldOfViewAngle.Value, viewDistance.Value, searchObject.Value);
            } else {
